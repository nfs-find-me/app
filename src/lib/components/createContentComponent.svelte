...
<div class="mx-auto flex flex-col items-center justify-center gap-5 p-8">
    ...
    <div class="mx-auto flex flex-row items-center justify-center gap-5 border-solid p-4">
        ...
        <div class="text-center">
            <img src={selectedFile.imageUrl} alt="Image Preview" class="rounded-lg w-40 h-24 border border-2 border-sky-500" />
        </div>
        {/if}
    ...
    <div class="w-2/4 h-96 m-6 flex flex-row border-4 border-sky-500 rounded-lg">
        ...
        <div class="w-80 p-2">
            <Input label={'Adresse'} type={InputTypeEnum.TEXT} id={'adress'} name={'adress'} />
            <Input label={'Ville'} type={InputTypeEnum.TEXT} id={'country'} name={'country'} />
            <Input label={'Code postal'} type={InputTypeEnum.TEXT} id={'zipcode'} name={'zipcode'} />
