...
<section>
    ...
    <div class="w-full flex justify-center items-center">
        <ul class="w-3/12 flex flex-row justify-center text-center">
            <li class="w-full">
                <a href="/profile/content"><span class="inline-block w-full p-4 text-lg cursor-pointer">Contenu</span></a>
            </li>
            <li class="w-full">
                <a href="/profile/create"><span class="inline-block w-full p-4 text-lg cursor-pointer">Créer</span></a>
            </li>
        </ul>
    </div>
